...
<aside class="notes">
- Store mengder tekst krever i noen tilfeller (RQs) strukturering av tekstene -- alt er ikke relevant.
- Ofte gjort manuelt (aviser, tidsskrifter, twitter #, generell manuell koding)
- Men veldig tidkrevende -> emnemodellering
</aside>
