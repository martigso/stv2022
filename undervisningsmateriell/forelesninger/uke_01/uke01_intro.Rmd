...
#  {data-background-gradient="inear-gradient(to right, #2274cc 0%,#26c5d3 36%,#61bf61 100%); /* W3C, IE10+, FF16+, Chrome26+,  Opera12+, Safari7+ */"}
...
1. <p style='background-color:black; color:#24D4A7'>Intro! (uke 34)</p>
2. <p style='background-color:black; color:#D13F11'>Anskaffelse og innlasting av tekst  (uke 35)</p>
3. <p style='background-color:black; color:#D13F11'>Forbehandling av tekst 1 (uke 36)</p>
4. <p style='background-color:black; color:#D13F11'>Forbehandling av tekst 2 (uke 37)</p>
5. <p style='background-color:black; color:#5B28D4'>Bruke API (Stortinget) (uke 38)</p>
6. <p style='background-color:black; color:#42D225'>Veiledet versus ikke-veiledet læring (uke 41)</p>
7. <p style='background-color:black; color:#42D225'>Ordbøker, tekstlikhet og sentiment (uke 42)</p>
8. <p style='background-color:black; color:#42D225'>Klassifisering av tekst -- temamodellering (uke 43)</p>
9. <p style='background-color:black; color:#42D225'>Estimere latent posisjon fra tekst (uke 44)</p>
10. <p style='background-color:black; color:#24D4A7'>Oppsummering! (uke 46)</p>
...
- <p style='background-color:rgba(0, 0, 0, .7); color:#D1B41B'>`r capture.output(print(refs["Silge2017"]))`</p>
    - <p style='background-color:rgba(0, 0, 0, .7); color:#00807D'>Tidy tekstformat</p>
- <p style='background-color:rgba(0, 0, 0, .7); color:#D1B41B'>`r capture.output(print(refs["Benoit2017"]))`</p>
    - <p style='background-color:rgba(0, 0, 0, .7); color:#00807D'>Tekstmodellering</p>
...
## <font color="white">\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Finne og hente data</font> {data-background=genius.png data-background-size="2500px"}
...
## Strukturere og preprosessere data
