...
## ----virksomme_topics, echo=TRUE, eval=FALSE------
## 
## library(tidyverse)
## library(tidytext)
## 
...
## ----load_virkdfm, echo=FALSE, eval=TRUE----------
load("./data/virksommeord_id.rda")
load("./data/virksommeord_dfm.rda")



## ----lda_est, echo=TRUE, eval=FALSE---------------
## 
## library(stm)
## 
## # Estimere LDA-modell
...
## ----load_lda_est, echo=FALSE, eval=TRUE----------
library(stm)
load("./data/virkord_lda.rda")


## ----lda_topwords, echo=TRUE, eval=TRUE-----------
plot(virkord_lda)



## ----lda_topwords2, echo=TRUE, eval=TRUE----------
plot(virkord_lda, labeltype = "frex")



## ----lda_toptexts, echo=TRUE, eval=TRUE-----------
...
## ----lda_store_toptextindex, echo=TRUE, eval=TRUE----
...
## ----topptekst_meta_inspect, echo=TRUE, eval=TRUE----

virkord[topptekster_t7lda$index$`Topic 7`, ]


## ----lda_searchtopics, echo=TRUE, eval=TRUE-------
